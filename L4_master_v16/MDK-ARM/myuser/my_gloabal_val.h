...
//周期和DAC，计算利用历史数据
#define USE_olde_12T_data_cyc 1  //1周期，DAC利用旧的12T数据，提高速度,0为用最新计算的12T结果
...
//是否使用周期模拟 报警
#define USER_simulate_alarm_status 1  //是否使用模拟报警，1为使用周期模拟报警，0为不使用

//是否使用上传录波数据
#define USER_update_record_data_status 0  //1为报警后上传录波数据，0为报警后不上传录波数据
