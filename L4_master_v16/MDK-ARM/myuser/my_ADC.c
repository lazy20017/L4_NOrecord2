...
extern float ADC1_Filer_value_buf[ADC1_COLM];  //用来存储ADC1采样到的的DC直流数据，共7个通道，真实值，转换后的
...
void my_adc_1_convert(void)
{
    ...
    x=(float)(ADC1_GetValue_Aver[0]*MY_VDD/4096);
    ADC1_Filer_value_buf[0]=(float)((x-0.76)*1000/(float)2.5+30);
